...
public partial class TelegramUpdateHandler : IUpdateHandler
{
    ...
    private static async Task SendRojao(ITelegramBotClient botClient, Message message,
        CancellationToken cancellationToken)
    {
    ...
    public TelegramUpdateHandler(ITelegramBotClient botClient, ILogger<TelegramUpdateHandler> logger,
